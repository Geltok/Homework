...
#Функция (определить цифры в строке)
...
if not is_int(sequence_numbers):
    print('\nВ вводе содержатся не цифры или не целые числа (введите числа, согласно условиям ввода.)\n')
    print(error)
else:
    sequence_numbers = sequence_numbers.split()

#Меняю список строк на список чисел
